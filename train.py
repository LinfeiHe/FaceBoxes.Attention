...
from layers.modules import MultiBoxLoss, CrossEntropyLoss2d
...
parser.add_argument('--save_folder', default='./weights_att_incep/', help='Location to save checkpoint models')
